    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , password:  "La contraseña debe contener como minimo 8 caracteres, una letra mayuscula y un caracter especial o número."        
        }
      ...
      , minlength:      "Este valor es muy corto. Deberia tener %s caracteres o más.."
      , maxlength:      "Este valor es demasiado largo. Deberia tener %s caracteres o menos"
      , rangelength:    "Esta longitud de valor no es válida. Debe tener entre %s y %s caracteres de longitud."
